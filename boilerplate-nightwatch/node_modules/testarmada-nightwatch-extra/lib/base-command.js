...
Base.prototype.pass = function (_ref) {
  ...
  var pactual = actual || "visible";
  var pexpected = pactual;
  var message = (this.isSync ? "[sync mode] " : "") + this.successMessage;
...
Base.prototype.fail = function (_ref2) {
  ...
  var message = "" + (this.isSync ? "[sync mode] " : "") + this.failureMessage + " [[" + pcode + "]]";

  this.time.totalTime = new Date().getTime() - this.startTime;
  this.client.assertion(false, pactual, pexpected, _util2.default.format(message, this.time.totalTime), true);
