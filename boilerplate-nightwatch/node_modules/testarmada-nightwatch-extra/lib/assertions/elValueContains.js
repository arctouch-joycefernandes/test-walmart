...
var ElValueContains = function ElValueContains() {
...
_util2.default.inherits(ElValueContains, _baseAssertion2.default);
...
ElValueContains.prototype.assert = function (actual, expected) {
  ...
  if (expected === undefined || actual === undefined || actual.indexOf(expected) < 0 && !new RegExp(expected).exec(actual)) {
...
ElValueContains.prototype.command = function (selector, expected) {
  ...
  this.message = _util2.default.format("Testing if selector <%s> has value <%s> after %d milliseconds ", this.selector, this.expected);
...
//# sourceMappingURL=elValueContains.js.map