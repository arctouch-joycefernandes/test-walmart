...
var ClearElValue = function ClearElValue() {
...
_util2.default.inherits(ClearElValue, _clickEl2.default);
...
ClearElValue.prototype.do = function (magellanSel) {
  ...
  this.client.api.clearValue("css selector", "[" + this.selectorPrefix + "='" + magellanSel + "']", function () {
...
//# sourceMappingURL=clearElValue.js.map